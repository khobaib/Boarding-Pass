...
/**
 * The adapter for the boarding-pass list shown when clicked on alert.
 * 
 * @author Sumon
 * 
 */
public class AdapterForBoardingPassFromAlert extends BaseAdapter {
	String month;
	String day;
	 ...
	 * @param item
	 */
	public AdapterForBoardingPassFromAlert(Context context, ArrayList<BoardingPass> item) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.boarding_pass_inflate_from_alert_dialog, null);
